...
const GKMoodEngine = (() => {
   ...
   * - Medium energy (40-64): Mixed pacing
   * - Low energy (<40): Shorter core sessions first
   */
  function calibrateSession(brainBattery, vibe) {
    ...
    if (score >= 65) {
      ...
      return {
        ...
        message: 'Take it steady today — we\'ll begin with a lighter core lesson and build from there.',
        sessionOrder: 'core-first',
        recommendWellness: false
      };
    }
