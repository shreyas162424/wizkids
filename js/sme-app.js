...
window.GKSmeApp = (function () {
        ...
        <div class="sme-header-right" style="display: flex; align-items: center; gap: 1rem;">
          <div style="display: flex; align-items: center; gap: 0.5rem; background: rgba(255,255,255,0.5); padding: 4px 12px 4px 4px; border-radius: 20px; border: 1px solid #e8c96a;">
            <img src="${avatar}" alt="Avatar" style="width: 28px; height: 28px; border-radius: 50%; object-fit: cover; background: #eee; display: block;" 
                 onerror="this.src='${GKBranding.logoPath()}'; this.onerror=null;" />
  ...
  const HUMAN_REVIEW_IDS = [
    ...
    'data-handling',            // Statistics — interpretation needs human eye
    'methods-of-separation'     // Science — procedure accuracy is critical
  ];
    ...
    return `
      <div class="sme-login-wrap">
        <div class="sme-login-card">
          ...
          <h1 class="sme-login-title">${GKBranding.get('smeLoginTitle')}</h1>
          <p class="sme-login-sub">${GKBranding.get('smeLoginSubtitle')}</p>
    ...
    <div class="sme-layout">
      <header class="sme-header">
        <div class="sme-header-brand">
          <img src="${GKBranding.logoPath()}" alt="${GKBranding.schoolName()}"
               style="width:34px;height:auto;border-radius:50%;flex-shrink:0;" />
          <div>
            <div class="sme-brand-name">${GKBranding.schoolName()}</div>
            <div class="sme-brand-sub">${GKBranding.get('smeGuideHeaderSubtitle')}</div>
          </div>
        </div>
        ${renderHeaderRight()}
      </header>
    ...
    <div class="sme-layout">
      ...
      <header class="sme-header">
        <div class="sme-header-brand">
          ...
          <div>
            <div class="sme-brand-name">${GKBranding.schoolName()}</div>
            <div class="sme-brand-sub">${GKBranding.get('smeHeaderSubtitle')}</div>
          </div>
        </div>
        ${renderHeaderRight()}
      </header>
